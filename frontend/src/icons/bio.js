...
const Bio = ({size}) => (
	<svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
    <defs>
        <filter id="bio_a" width="112.1%" height="112.1%" x="-5.6%" y="-4.8%" filterUnits="objectBoundingBox">
            <feOffset dx="1" dy="2" in="SourceAlpha" result="shadowOffsetOuter1"/>
            <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation="2"/>
            <feColorMatrix in="shadowBlurOuter1" result="shadowMatrixOuter1" values="0 0 0 0 0.843137255 0 0 0 0 0.717647059 0 0 0 0 0.529411765 0 0 0 1 0"/>
            <feMerge>
