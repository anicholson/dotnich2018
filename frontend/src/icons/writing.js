...
const Writing = ({size}) => (
<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
    <defs>
        <circle className={styles.icon} id="writing_b" cx="64" cy="64" r="58"/>
